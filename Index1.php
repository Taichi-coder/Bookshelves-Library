    ...
    <main>
        <div class="container">
            ...
            <div class="thead thead3">
                ...
                <p class="boy"><?php echo $row['yearOfBook'] ?></p><p class="nop nop2"><?php echo $row['numberOfPage'] ?></p>
                <p class="det"><a href="read_more.php?id=<?php echo $row['id'] ?>"><?php if(strlen($row['details']) > 50) {
